...
export default function InterviewGuidePage() {
    return (
        <>
            <Helmet>
                <title>{buildTitle(l('Interview Guide'))}</title>
            </Helmet>

            {/* Hero */}
            <Hero title={l('Interview Guide hero title')} />
                    ...
                    <div className='d-none d-md-flex col-md-3'>
                        <nav id='navbar-example3' className='h-100 flex-column align-items-stretch pe-4 border-end'>
                            <nav className='nav nav-pills flex-column'>
                                <a className='nav-link' href='#item-1'>Before the Interview</a>
                                <nav className='nav nav-pills flex-column'>
                                    <a className='nav-link ms-3 my-1' href='#item-1-1'>Resume</a>
                                    <a className='nav-link ms-3 my-1' href='#item-1-2'>Job Applications</a>
                                </nav>
                                <a className='nav-link' href='#item-2'>The First Stage</a>
                                <nav className='nav nav-pills flex-column'>
                                    <a className='nav-link ms-3 my-1' href='#item-1-1'>Recruiter Phone Screen</a>
                                    <a className='nav-link ms-3 my-1' href='#item-1-2'>Technical Screen</a>
                                    <a className='nav-link ms-3 my-1' href='#item-1-3'>Online assessment</a>
                                </nav>
                                <a className='nav-link' href='#item-3'>Onsite interviews</a>
                                <nav className='nav nav-pills flex-column'>
                                    <a className='nav-link ms-3 my-1' href='#item-3-1'>Behavioural Interviews</a>
                                    <a className='nav-link ms-3 my-1' href='#item-3-2'>Coding Interviews</a>
                                    <a className='nav-link ms-3 my-1' href='#item-3-3'>Systems Design Interviews</a>
                                    <a className='nav-link ms-3 my-1' href='#item-3-4'></a>
                                </nav>
                                <a className='nav-link' href='#item-3'>Leadership</a>
                                <a className='nav-link' href='#item-4'>Site Reliability Engineering</a>
                            </nav>
                        </nav>
                    </div>
